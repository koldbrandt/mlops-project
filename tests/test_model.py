...
@pytest.mark.parametrize("test_input,expected", [(torch.randn(1,1,2,3), ValueError), (torch.randn(1,1,28,3), ValueError), (torch.randn(1,1,2,28), ValueError), (torch.randn(1,2,28,28), ValueError)])
